...
type ApiCompanyCapexEstimatesRequest struct {
	ctx        _context.Context
	ApiService *DefaultApiService
	symbol     *string
	freq       *string
...
// Symbol of the company: AAPL.
func (r ApiCompanyCapexEstimatesRequest) Symbol(symbol string) ApiCompanyCapexEstimatesRequest {
	r.symbol = &symbol
	return r
}

// Can take 1 of the following values: &lt;code&gt;annual, quarterly&lt;/code&gt;. Default to &lt;code&gt;quarterly&lt;/code&gt;
func (r ApiCompanyCapexEstimatesRequest) Freq(freq string) ApiCompanyCapexEstimatesRequest {
	r.freq = &freq
	return r
}

func (r ApiCompanyCapexEstimatesRequest) Execute() (CapexEstimates, *_nethttp.Response, error) {
	return r.ApiService.CompanyCapexEstimatesExecute(r)
}

/*
CompanyCapexEstimates CapEx Estimates

Get company's capital expenditure estimates.

	@param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCompanyCapexEstimatesRequest
*/
func (a *DefaultApiService) CompanyCapexEstimates(ctx _context.Context) ApiCompanyCapexEstimatesRequest {
	return ApiCompanyCapexEstimatesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return CapexEstimates
func (a *DefaultApiService) CompanyCapexEstimatesExecute(r ApiCompanyCapexEstimatesRequest) (CapexEstimates, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  CapexEstimates
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CompanyCapexEstimates")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/capex-estimate"
...
type ApiCompanyFcfEstimatesRequest struct {
	ctx        _context.Context
	ApiService *DefaultApiService
	symbol     *string
	freq       *string
...
// Symbol of the company: AAPL.
func (r ApiCompanyFcfEstimatesRequest) Symbol(symbol string) ApiCompanyFcfEstimatesRequest {
	r.symbol = &symbol
	return r
}

// Can take 1 of the following values: &lt;code&gt;annual, quarterly&lt;/code&gt;. Default to &lt;code&gt;quarterly&lt;/code&gt;
func (r ApiCompanyFcfEstimatesRequest) Freq(freq string) ApiCompanyFcfEstimatesRequest {
	r.freq = &freq
	return r
}

func (r ApiCompanyFcfEstimatesRequest) Execute() (FcfEstimates, *_nethttp.Response, error) {
	return r.ApiService.CompanyFcfEstimatesExecute(r)
}

/*
CompanyFcfEstimates FCF Estimates

Get company's free cash flow estimates.

	@param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCompanyFcfEstimatesRequest
*/
func (a *DefaultApiService) CompanyFcfEstimates(ctx _context.Context) ApiCompanyFcfEstimatesRequest {
	return ApiCompanyFcfEstimatesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return FcfEstimates
func (a *DefaultApiService) CompanyFcfEstimatesExecute(r ApiCompanyFcfEstimatesRequest) (FcfEstimates, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  FcfEstimates
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CompanyFcfEstimates")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/fcf-estimate"
...
type ApiCompanyOcfEstimatesRequest struct {
	ctx        _context.Context
	ApiService *DefaultApiService
	symbol     *string
	freq       *string
...
// Symbol of the company: AAPL.
func (r ApiCompanyOcfEstimatesRequest) Symbol(symbol string) ApiCompanyOcfEstimatesRequest {
	r.symbol = &symbol
	return r
}

// Can take 1 of the following values: &lt;code&gt;annual, quarterly&lt;/code&gt;. Default to &lt;code&gt;quarterly&lt;/code&gt;
func (r ApiCompanyOcfEstimatesRequest) Freq(freq string) ApiCompanyOcfEstimatesRequest {
	r.freq = &freq
	return r
}

func (r ApiCompanyOcfEstimatesRequest) Execute() (OcfEstimates, *_nethttp.Response, error) {
	return r.ApiService.CompanyOcfEstimatesExecute(r)
}

/*
CompanyOcfEstimates OCF Estimates

Get company's operating cash flow estimates.

	@param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCompanyOcfEstimatesRequest
*/
func (a *DefaultApiService) CompanyOcfEstimates(ctx _context.Context) ApiCompanyOcfEstimatesRequest {
	return ApiCompanyOcfEstimatesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return OcfEstimates
func (a *DefaultApiService) CompanyOcfEstimatesExecute(r ApiCompanyOcfEstimatesRequest) (OcfEstimates, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  OcfEstimates
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CompanyOcfEstimates")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/ocf-estimate"
